...
Sandbox API Repository to describe, develop, document, and test the OptimalEdgeDiscovery Service API(s). The repository does not yet belong to a CAMARA Sub Project.
...
Incubating API Repository to evolve and maintain the definitions and documentation of OptimalEdgeDiscovery Service API(s) within the Sub Project [Edge Cloud](https://lf-camaraproject.atlassian.net/wiki/x/IwEpBQ)
