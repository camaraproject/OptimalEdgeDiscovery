...
Feature: CAMARA Optimal Edge Discovery API, v0.2.0-rc.1 - Operations for discovering optimal edge cloud zones
...
# References to OAS spec schemas refer to schemas specified in optimal-edge-discovery.yaml
  ...
  Background: Common Optimal Edge Discovery setup
    ...
    And the resource "/optimal-edge-discovery/v0.2rc1"
